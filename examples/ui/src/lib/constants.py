...
KEYCLOAK_CONSOLE_URL_OFF_CLUSTER = "http://keycloak.localtest.me:8080/admin/master/console/"
KEYCLOAK_CONSOLE_URL_IN_CLUSTER = "http://keycloak.keycloak.svc.cluster.local:8080/admin/master/console/"
...
# DEFAULT_REPO_USER = "pdettori" # REMOVED - will be fetched from secret
DEFAULT_IMAGE_TAG = "v0.0.1"
# DEFAULT_IMAGE_REGISTRY_PREFIX will be constructed using fetched user

# --- Kubernetes Secret for Git User ---
GIT_USER_SECRET_NAME = "github-token-secret"
GIT_USER_SECRET_KEY = "user" # The key within the secret that holds the username
...
DEFAULT_ENV_VARS = [
    ...
    {"name": "OTEL_EXPORTER_OTLP_ENDPOINT", "value": "http://otel-collector.kagenti-system.svc.cluster.local:8335"},
    {"name": "KEYCLOAK_URL", "value": "http://keycloak.keycloak.svc.cluster.local:8080"}, # This is for agent's runtime env
]
