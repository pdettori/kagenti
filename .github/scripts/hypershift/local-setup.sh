...
echo "Next steps:"
echo ""
echo "  # Create a cluster (auto-prefixed with MANAGED_BY_TAG):"
echo "  ./.github/scripts/hypershift/create-cluster.sh              # → ${MANAGED_BY_TAG}-local"
echo ""
echo "  # Or with custom suffix:"
echo "  ./.github/scripts/hypershift/create-cluster.sh pr123        # → ${MANAGED_BY_TAG}-pr123"
echo ""
echo "  # Destroy a cluster (accepts suffix or full name):"
