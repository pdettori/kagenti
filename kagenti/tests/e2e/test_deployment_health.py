...
# ============================================================================
# Test: Weather Tool Deployment (Both Operators)
# ============================================================================


class TestWeatherToolDeployment:
    """Test weather-tool deployment health (works with both operators)."""
    ...
    @pytest.mark.skipif(
        "operator_mode != 'platform_operator'",
        reason="Service 'weather-tool' only exists in platform-operator mode",
    )
...
class TestWeatherServiceDeployment:
    ...
    @pytest.mark.skipif(
        "operator_mode != 'platform_operator'",
        reason="Service 'weather-service' only exists in platform-operator mode",
    )
